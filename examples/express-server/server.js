...
const FACILITATOR_URL = process.env.FACILITATOR_URL; // undefined = SDK default (x402.stablecoin.xyz)
...
app.listen(PORT, () => {
  ...
  console.log(`  amount  : ${AMOUNT} ($${AMOUNT / 10 ** 18})`);
  console.log(`  facilitator: ${FACILITATOR_URL ?? "https://x402.stablecoin.xyz (default)"}`);
});
